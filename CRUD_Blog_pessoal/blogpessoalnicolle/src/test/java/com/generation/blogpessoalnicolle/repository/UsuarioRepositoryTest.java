...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) // para o spring indentificar que é classe de  teste e abrira porta rondonica no pc
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // indica que é teste unitario e o clico de vida do teste tera inicio meio e fim.
